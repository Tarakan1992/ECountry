...
mysql -u "root" --password="asd123!1" -e "DROP DATABASE IF EXISTS ecountry_db;"
mysql -u "root" --password="asd123!1" -e "CREATE DATABASE ecountry_db;"
echo End create database

echo Start create tables 
mysql -u "root" --password="asd123!1" "ecountry_db" < "schema.sql"
echo End create tables 

echo Start fill initial data
mysql -u "root" --password="asd123!1" "ecountry_db" < "ref_data.sql"
...
mysql --default-character-set=utf8 -u "root" --password="asd123!1" "ecountry_db" < "test_data.sql"
